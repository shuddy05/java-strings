...
// HOISTING - behaviour ini JS where function declarations are moved to the top before the code is executed
...
const checkLoanEligibility1 = (loanAmount) =>
  savings * 2 < loanAmountN ? "User is Inligible" : "User is Eligible";
