...
if ((isFan && userB >= disccountP) || (!isFan && userB >= ticketPrice)) {
...
// A user is buying a jacket online. The price of the jacket is 250.
// If it’s a holiday sale, the jacket price is reduced by 50.

// Tasks:

// Store the jacket price in a variable.

// Store the discount amount (50) in another variable.

// Store the user’s balance in another variable.

// Calculate the final jacket price after discount.

// Use a conditional statement to check if the user can buy the jacket:

// If the user’s balance is greater than or equal to the final jacket price, print "You can buy the jacket".

// Otherwise, print "You do not have enough money to buy the jacket".

const jacketPrice = 250;
const discount = 50;
const Userb = 300;
const finalP = jacketPrice - disccount;
// if (Userb >= finalP) {
...
// 2. A student is applying for a driving license. The minimum age required is 16.

// Tasks:

// Store the minimum age requirement in a variable.

// Store the student’s age in another variable.

// Use a conditional statement to check if the student can apply:

// If the student’s age is greater than or equal to the minimum age, print "You are eligible for a driving license".

// Otherwise, print "You are not eligible for a driving license yet".
const minimumAgeRequired = 16;
const studentAge = 17;
// if (studentAge >= minimumAgeRequired) {
//   console.log("You are eligible for a driving license");
// } else {
//   console.log("You are not eligible for a driving license yet");
// }

studentAge >= minimumAgeRequired
  ? console.log("You are eligible for a driving license")
  : console.log("You are not eligible for a driving license yet");
